...
; A variable that controls the rendering of documentation comments (non level 1 comments) in the source programs.
; Normally true. When the elucidator is used to render the source program of SchemeDoc documentation, it
; may be useful to apply the value #f
(define render-documentation-comments-in-source-programs #t)
 ...
 (letrec
  ...
  (let*
    ((laml-resource-attr (as-boolean (ast-attribute front-matters-ast 'laml-resource "false")))
     ...
     (render-doc-comments-attr (as-boolean (ast-attribute front-matters-ast 'render-doc-comments "true")))
...
;  (set! make-small-source-files? small-font-source-file-attr)
  ...
  (set! render-documentation-comments-in-source-programs render-doc-comments-attr)
  )
 )
)
...
(define (render-syntactical-comment! comment-string comment-level op)
 (let ((sectional-comment (section-name-comment? comment-string)))
  ...
  (if (or render-documentation-comments-in-source-programs (not (= comment-level 2)))
