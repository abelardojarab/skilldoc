...
(define scheme-system 'mzscheme-300)
...
(define laml-version "Version 38.0 (November 14, 2011, schemedoc)")
...
(define (begin-laml)
  ...
  (if (and (not (equal? "~/.laml" "false")) (file-exists? "~/.laml"))
    (load "~/.laml")))
...
;; A variable which can be used to control if laml is safe and informative, or fast.
;; Possible values: fast or safe (a symbol).
