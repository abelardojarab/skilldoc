...
;; This directory is called the LAML temporary file directory.
;; In the default implementation, return temp in laml-dir.
;; You may redefine this function to return another path. This is necessary if you do not have write access to the default LAML temporary file directory.
;; Redefinition of the function can take place in your .laml file.
...
;; If you ever call this implementation of the function, it indicates a missing redefinition.
...
;; A convenience version of fake-startup-parameters which does not take program parameters as a rest parameter.
;; .parameter source-file a file name without initial path and without extension.
;; .parameter start-dir an absolute path to a directory ending in a slash /.
;; .program-parameters a list of strings.
...
;; Handle white space preserving elements according to the value (xml-preformatted-text-elements-in xml-language).
...
;; The LAML author's name and address information.
;; .form (kn-xml-in-laml [with-icon])
;; .parameter with-icon A boolean value which enables display of the LAML icon.
;; .misc I usually keep this and similar functions in my .laml file. A version in the .laml file will overwrite this function.
