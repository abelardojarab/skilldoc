...
enum {
  ...
  scheme_rt_read_params,
  scheme_rt_native_code,
  scheme_rt_native_code_plus_case,
  scheme_rt_jitter_data,
  scheme_rt_module_exports,
  scheme_rt_module_phase_exports,
  scheme_rt_delay_load_info,
  scheme_rt_marshal_info,
  scheme_rt_unmarshal_info,
  scheme_rt_runstack,
  _scheme_last_type_
};
...
extern void GC_init_type_tags(int count, int pair, int weakbox,
...
extern void GC_set_finalizer(void *p, int tagged, int level,
...
extern void GC_register_traversers(short tag, Size_Proc size, Mark_Proc mark, Fixup_Proc fixup,
...
extern void GC_mark_variable_stack(void **var_stack,
           long delta,
           void *limit,
                                       void *stack_mem);
extern void GC_fixup_variable_stack(void **var_stack,
     long delta,
     void *limit,
                                        void *stack_mem);
...
extern Scheme_Object *scheme_param_config(char *name, Scheme_Object *pos,
...
extern int scheme_setjmpup_relative(Scheme_Jumpup_Buf *b, void *base,
...
extern Scheme_Object *scheme_thread_w_details(Scheme_Object *thunk,
       Scheme_Config *init_config,
...
extern int scheme_block_until_enable_break(Scheme_Ready_Fun f, Scheme_Needs_Wakeup_Fun, Scheme_Object *,
           float, int enable);
extern int scheme_block_until_unless(Scheme_Ready_Fun f, Scheme_Needs_Wakeup_Fun fdf,
...
extern Scheme_Custodian_Reference *scheme_add_managed(Scheme_Custodian *m, Scheme_Object *o,
...
extern void scheme_add_evt(Scheme_Type type,
       Scheme_Ready_Fun ready,
       Scheme_Needs_Wakeup_Fun wakeup,
       Scheme_Sync_Filter_Fun filter,
       int can_redirect);
extern void scheme_add_evt_through_sema(Scheme_Type type,
...
extern void scheme_wrong_count(const char *name, int minc, int maxc,
      int argc, Scheme_Object **argv);
extern void scheme_wrong_count_m(const char *name, int minc, int maxc,
        int argc, Scheme_Object **argv,
        int is_method);
extern void scheme_case_lambda_wrong_count(const char *name, int argc,
           Scheme_Object **argv, int is_method, int count, ...);
extern void scheme_wrong_type(const char *name, const char *expected,
     int which, int argc,
     Scheme_Object **argv);
extern void scheme_wrong_field_type(Scheme_Object *c_name,
           const char *expected,
           Scheme_Object *o);
extern void scheme_arg_mismatch(const char *name, const char *msg, Scheme_Object *o);
extern void scheme_wrong_return_arity(const char *where,
      int expected, int got,
      Scheme_Object **argv,
      const char *context_detail, ...);
extern void scheme_unbound_global(Scheme_Bucket *b);
extern Scheme_Object *scheme_dynamic_wind(void (*pre)(void *),
...
extern Scheme_Object *_scheme_apply_known_prim_closure(Scheme_Object *rator, int argc,
         Scheme_Object **argv);
extern Scheme_Object *_scheme_apply_known_prim_closure_multi(Scheme_Object *rator, int argc,
        Scheme_Object **argv);
extern Scheme_Object *_scheme_apply_prim_closure(Scheme_Object *rator, int argc,
          Scheme_Object **argv);
extern Scheme_Object *_scheme_apply_prim_closure_multi(Scheme_Object *rator, int argc,
         Scheme_Object **argv);
...
extern Scheme_Object *scheme_extract_one_cc_mark(Scheme_Object *mark_set,
          Scheme_Object *key);
extern Scheme_Object *scheme_extract_one_cc_mark_to_tag(Scheme_Object *mark_set,
                                                           Scheme_Object *key,
                                                           Scheme_Object *prompt_tag);
extern Scheme_Object *scheme_do_eval(Scheme_Object *obj, int _num_rands, Scheme_Object **rands, int val);
extern Scheme_Object *scheme_eval_compiled_stx_string(Scheme_Object *expr, Scheme_Env *env,
...
extern Scheme_Object *scheme_eval_compiled_sized_string_with_magic(const char *str, int len, Scheme_Env *env,
...
extern void scheme_register_finalizer(void *p,
...
extern Scheme_Object *scheme_make_prim_w_arity(Scheme_Prim *prim, const char *name,
     mzshort mina, mzshort maxa);
extern Scheme_Object *scheme_make_folding_prim(Scheme_Prim *prim,
     const char *name,
     mzshort mina, mzshort maxa,
     short functional);
extern Scheme_Object *scheme_make_noncm_prim(Scheme_Prim *prim,
      const char *name,
      mzshort mina, mzshort maxa);
extern Scheme_Object *scheme_make_noneternal_prim_w_arity(Scheme_Prim *prim,
         const char *name,
         mzshort mina, mzshort maxa);
extern Scheme_Object *scheme_make_prim_w_everything(Scheme_Prim *fun, int eternal,
             const char *name,
             mzshort mina, mzshort maxa,
             int folding,
             mzshort minr, mzshort maxr);
extern Scheme_Object *scheme_make_prim_closure_w_arity(Scheme_Primitive_Closure_Proc *prim,
         int size, Scheme_Object **vals,
         const char *name,
         mzshort mina, mzshort maxa);
extern Scheme_Object *scheme_make_folding_prim_closure(Scheme_Primitive_Closure_Proc *prim,
         int size, Scheme_Object **vals,
         const char *name,
         mzshort mina, mzshort maxa,
         short functional);
extern Scheme_Object *scheme_make_closed_prim(Scheme_Closed_Prim *prim, void *data);
extern Scheme_Object *scheme_make_closed_prim_w_arity(Scheme_Closed_Prim *prim,
        void *data, const char *name,
        mzshort mina, mzshort maxa);
extern Scheme_Object *scheme_make_folding_closed_prim(Scheme_Closed_Prim *prim,
        void *data, const char *name,
        mzshort mina, mzshort maxa,
        short functional);
extern Scheme_Object *scheme_make_closed_prim_w_everything(Scheme_Closed_Prim *fun,
             void *data,
             const char *name,
             mzshort mina, mzshort maxa,
             short folding,
...
extern int scheme_utf8_decode_as_prefix(const unsigned char *s, int start, int end,
        unsigned int *us, int dstart, int dend,
        long *ipos, char utf16, int permissive);
extern int scheme_utf8_decode_all(const unsigned char *s, int len, unsigned int *us,
         int permissive);
extern int scheme_utf8_decode_prefix(const unsigned char *s, int len, unsigned int *us,
     int permissive);
extern mzchar *scheme_utf8_decode_to_buffer(const unsigned char *s, int len,
            mzchar *buf, int blen);
extern mzchar *scheme_utf8_decode_to_buffer_len(const unsigned char *s, int len,
         mzchar *buf, int blen, long *rlen);
__xform_nongcing__ extern int scheme_utf8_decode_count(const unsigned char *s, int start, int end,
            int *_state, int might_continue, int permissive);
extern int scheme_utf8_encode(const unsigned int *us, int start, int end,
     unsigned char *s, int dstart,
     char utf16);
extern int scheme_utf8_encode_all(const unsigned int *us, int len, unsigned char *s);
extern char *scheme_utf8_encode_to_buffer(const mzchar *s, int len,
          char *buf, int blen);
extern char *scheme_utf8_encode_to_buffer_len(const mzchar *s, int len,
       char *buf, int blen, long *rlen);
extern unsigned short *scheme_ucs4_to_utf16(const mzchar *text, int start, int end,
            unsigned short *buf, int bufsize,
            long *ulen, int term_size);
extern mzchar *scheme_utf16_to_ucs4(const unsigned short *text, int start, int end,
...
extern long scheme_put_byte_string(const char *who, Scheme_Object *port,
          const char *str, long d, long len,
          int rarely_block);
extern long scheme_put_char_string(const char *who, Scheme_Object *port,
...
extern long scheme_get_byte_string(const char *who,
          Scheme_Object *port,
          char *buffer, long offset, long size,
          int only_avail,
          int peek, Scheme_Object *peek_skip);
extern long scheme_get_byte_string_unless(const char *who,
          Scheme_Object *port,
          char *buffer, long offset, long size,
          int only_avail,
          int peek, Scheme_Object *peek_skip,
          Scheme_Object *unless_evt);
extern long scheme_get_byte_string_special_ok_unless(const char *who,
       Scheme_Object *port,
       char *buffer, long offset, long size,
       int only_avail,
       int peek, Scheme_Object *peek_skip,
...
extern int scheme_peeked_read(Scheme_Object *port,
     long size,
     Scheme_Object *unless_evt,
     Scheme_Object *target_evt);
extern long scheme_get_char_string(const char *who,
          Scheme_Object *port,
...
extern Scheme_Object *scheme_make_write_evt(const char *who, Scheme_Object *port,
...
extern Scheme_Input_Port *scheme_make_input_port(Scheme_Object *subtype, void *data,
          Scheme_Object *name,
          ...
          Scheme_Need_Wakeup_Input_Fun need_wakeup_fun,
          int must_close);
extern Scheme_Output_Port *scheme_make_output_port(Scheme_Object *subtype, void *data,
            Scheme_Object *name,
            ...
            Scheme_Write_Special_Fun write_special_fun,
            int must_close);
extern void scheme_set_port_location_fun(Scheme_Port *port,
         Scheme_Location_Fun location_fun);
extern void scheme_set_port_count_lines_fun(Scheme_Port *port,
            Scheme_Count_Lines_Fun count_lines_fun);
extern Scheme_Object *scheme_progress_evt_via_get(Scheme_Input_Port *port);
extern int scheme_peeked_read_via_get(Scheme_Input_Port *port,
      long size,
      Scheme_Object *unless_evt,
      Scheme_Object *target_ch);
extern Scheme_Object *scheme_write_evt_via_write(Scheme_Output_Port *port,
          const char *str, long offset, long size);
extern Scheme_Object *scheme_write_special_evt_via_write_special(Scheme_Output_Port *port,
...
extern struct addrinfo *scheme_get_host_address(const char *address, int id, int *err,
...
extern void scheme_getnameinfo(void *sa, int salen,
...
extern void scheme_socket_to_ports(long s, const char *name, int takeover,
...
extern void scheme_add_global_symbol(Scheme_Object *name, Scheme_Object *val,
         Scheme_Env *env);
...
extern void scheme_set_global_bucket(char *proc, Scheme_Bucket *var, Scheme_Object *val,
         int set_undef);
...
extern Scheme_Object *scheme_make_modidx(Scheme_Object *path,
      Scheme_Object *base,
...
extern Scheme_Object **scheme_make_struct_values(Scheme_Object *struct_type,
       Scheme_Object **names,
       int count, int flags);
extern Scheme_Object **scheme_make_struct_names(Scheme_Object *base,
      Scheme_Object *field_names,
      int flags, int *count_out);
extern Scheme_Object *scheme_make_struct_type(Scheme_Object *base,
       ...
       Scheme_Object *guard);
extern Scheme_Object *scheme_make_struct_instance(Scheme_Object *stype,
           int argc,
           Scheme_Object **argv);
extern Scheme_Object *scheme_make_struct_exptime(Scheme_Object **names, int count,
...
extern Scheme_Object *scheme_make_location(Scheme_Object *src,
           Scheme_Object *line,
           Scheme_Object *col,
           Scheme_Object *pos,
           Scheme_Object *span);
...
extern void scheme_set_type_equality(Scheme_Type type,
                                        Scheme_Equal_Proc f,
...
extern Scheme_Object *scheme_map_1(Scheme_Object *(*f)(Scheme_Object*),
       Scheme_Object *l);
...
extern int scheme_check_proc_arity(const char *where, int a,
          int which, int argc, Scheme_Object **argv);
extern int scheme_check_proc_arity2(const char *where, int a,
           int which, int argc, Scheme_Object **argv,
           int false_ok);
...
struct Scheme_Prompt *scheme_get_barrier_prompt(struct Scheme_Meta_Continuation **_meta_cont,
                                                long *_pos);
int scheme_is_cm_deeper(struct Scheme_Meta_Continuation *m1, long p1,
                        struct Scheme_Meta_Continuation *m2, long p2);
