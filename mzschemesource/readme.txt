This is the MzScheme v372 source package directory for Unix.

You must compile MzScheme before using the MzScheme software.
...
menu, or run bin/help-desk.  Also, visit http://www.plt-scheme.org/.
